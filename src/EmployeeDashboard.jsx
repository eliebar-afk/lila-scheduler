            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 12 }}>
              <thead>
                <tr>
                  ...
                  {DAYS.map(d => (
                    <th key={d} style={{ padding: '8px 4px', color: d === TODAY ? '#44ab51' : '#888', fontWeight: d === TODAY ? 800 : 600, textAlign: 'center', minWidth: 60, background: d === TODAY ? '#f0faf0' : 'transparent', borderRadius: 6 }}>
                      {d.slice(0, 3)}
                    </th>
                  ))}
                </tr>
                        ...
                        <td key={day} style={{ padding: '4px', textAlign: 'center' }}>
                          {shift ? (
                            <div style={{
                              ...
                              background: shift ? `${getShiftColor(shift.start_time)}15` : '#f9f9f9',
                              border: `1px solid ${shift ? getShiftColor(shift.start_time) : '#ddd'}`,
                              minHeight: 36, display: 'flex', flexDirection: 'column',
                              alignItems: 'center', justifyContent: 'center'
                            }}>
                            <span style={{ fontSize: 10, color: getShiftColor(shift.start_time), fontWeight: 600 }}>{shift.start_time}</span>
