          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            {newScheduleAlert && (
              <div style={{
                ...
                justifyContent: 'space-between',
                alignItems: 'center',
                boxShadow: '0 4px 16px rgba(68,171,81,0.3)',
              }}>
                <div>
                ...
                <tbody>
                  {employees.map(emp => (
                    <tr key={emp.id} style={{ borderTop: '1px solid #f3f4f6' }}>
                      <td style={{
                        padding: '8px 10px',
                        fontWeight: emp.id === user.id ? 700 : 500,
                        color: emp.id === user.id ? '#44ab51' : '#374151',
                        fontSize: 13,
                      }}>
                          ...
                          <td key={day} style={{ padding: '4px 3px', textAlign: 'center' }}>
                            {shift ? (
                              <div style={{
                                ...
                                background: getShiftColor(shift.start_time),
                                minHeight: 36,
            ...
            {handoverTasks.filter(t => !t.completed).length > 0 && (
              <div style={card}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
                  ...
                  <button onClick={() => setTab('handover')} style={{
                    background: '#edf8ee', color: '#44ab51', padding: '4px 12px', fontSize: 12, fontWeight: 600, borderRadius: 8,
                  }}>See all</button>
                </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            <div style={card}>
              ...
              <div style={{
                ...
                background: isOnRestaurantWifi ? '#edf8ee' : '#fef2f2',
                border: `1px solid ${isOnRestaurantWifi ? '#bbdfc0' : '#fca5a5'}`,
              }}>
                <div style={{
                  width: 10, height: 10, borderRadius: '50%', flexShrink: 0,
                  background: isOnRestaurantWifi ? '#44ab51' : '#dc2626',
                  boxShadow: `0 0 0 3px ${isOnRestaurantWifi ? 'rgba(68,171,81,0.2)' : 'rgba(220,38,38,0.2)'}`,
                }} />
              ...
              {attendance && (
                <div style={{ padding: '14px 16px', background: '#f8f9fa', borderRadius: 12, marginBottom: 20, border: '1px solid #e5e9f0' }}>
                  <p style={{ fontSize: 12, color: '#9ca3af', marginBottom: 8, fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.04em' }}>Today's Record</p>
              ...
              {!attendance?.check_in ? (
                <button
                  ...
                  style={{
                    ...
                    background: isOnRestaurantWifi
                      ? 'linear-gradient(135deg, #44ab51 0%, #37944a 100%)'
                      : '#e5e9f0',
                ...
                <div style={{
                  ...
                  background: '#edf8ee', borderRadius: 14,
              ...
              <div key={day} style={{ marginBottom: 10 }}>
                ...
                >
                  <div style={{
                    ...
                    background: preferences[day] ? '#44ab51' : '#e5e9f0',
                ...
                {preferences[day] && (
                  <div style={{
                    ...
                    background: '#edf8ee', borderRadius: '0 0 12px 12px',
                    marginTop: -4, border: '1.5px solid #44ab51', borderTop: 'none',
                  }}>
                    {[
            ...
            <div style={card}>
              ...
              {handoverTasks.length === 0 && (
                <p style={{ color: '#9ca3af', fontSize: 14, textAlign: 'center', padding: '24px 0' }}>
                  No tasks yet. Add something for the next shift!
                </p>
              )}
            </div>
          </div>
